...
public class Board {
    ...
    public Board() {
        fields = new Field[40];
            ...
            fields[1] = new Street("Rødovrevej", 1,1200, "1.200 kr", "Leje af grund: 50 kr. \n m/ 1 hus: 250 \n 2 huse: 750 \n 3 huse: 2.225 \n 4 huse: 4.000 \n hotel: 6.000 \n Pris pr. hus/hotel: 1000", "", new Color(13,90,184), Color.black, 0, 50, 1000, 250, 750, 2250, 4000, 6000);
